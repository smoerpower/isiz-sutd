...
if (isset($_POST['add'])) {
    ...
    if (mysqli_query($conn, $query)) {
        echo '<div class="alert alert-success ">Запись успешно добавлена! Чтобы вернуться в админку, <a href="admin.php" class="alert-link">нажми сюда</a></div>';
        mysqli_close($conn);
    } else {
          ...
          <!-- Кнопки -->
            <div class="col-lg-12">
              <div class="btn-toolbar" role="toolbar">
                ...
                <button class="btn btn-success pull-right" name="save" value="Сохранить">Редактировать</button>
